# 模型介绍
> 来自清华和地平线的论文“[SparseDrive](https://zhida.zhihu.com/search?content_id=252280537&content_type=Article&match_order=1&q=SparseDrive&zhida_source=entity): End-to-End Autonomous Driving via Sparse Scene Representation”，通过稀疏场景表示来实现端到端自动驾驶新范式，兼具SOTA的性能和易于部署的优点。加速版相较原版在部分场景上性能有50%~100%左右的提升
