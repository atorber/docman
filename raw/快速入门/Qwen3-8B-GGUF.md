Qwen3-8B 是通义千问系列最新一代大语言模型，参数量8.2B。
...
* 默认使用 Q8_0 量化精度（即 Qwen3-8B-Q8_0.gguf）进行部署。
* 如需使用其它精度，待服务部署成功后可在"在线服务部署"中 升级服务 修改服务的启动参数。以Q5_K_M为例，参数修改为--model /mnt/aihc_model_dir/Qwen3-8B-Q5_K_M.gguf
