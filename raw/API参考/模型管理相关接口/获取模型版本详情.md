...
### **请求结构**
```bash
GET ?action=DescribeModelVersion&modelId=xxx&versionId=xxx
HTTP/1.1
...
|updatedAt|String|模型更新时间|
|owner|String|所有者|
|ownerName|String|所有者名称|
|visibilityScope|String|可见范围|
|versionEntry|[ModelVersionEntry](AIHC/API参考/数据结构.md#ModelVersionEntry)|查询的版本的详细信息|
...
```json
{
    "requestId": "1b3e3dac-51b7-4114-998e-f6548cb319f4",
    "name": "my-model-1",
    "id": "mo-vnufEepi",
