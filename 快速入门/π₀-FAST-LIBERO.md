π₀-FAST-LIBERO 是由 Physical Intelligence 团队开发的开源视觉-语言-动作（VLA）模型，旨在实现通用机器人控制。采用自回归预测 + FAST（Frequency-space Action Sequence Tokenization）动作分词器，将连续动作离散化为 token 序列，能根据语言指令和多视角 RGB 图像预测64个机器人动作，适用于单臂、双臂、移动机械臂等多种机器人平台。
...
![image.png](https://bce.bdstatic.com/doc/bce-doc/AIHC/image_c4b9eb7.png)
