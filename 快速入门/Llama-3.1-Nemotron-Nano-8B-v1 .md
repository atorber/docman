 Llama-3.1-Nemotron-Nano-8B-v1 是英伟达开源基于Llama-3.1-8B-Instruct微调的推理模型，参数量253B。专注于推理、聊天偏好和任务以及 RAG和工具调用。该模型在模型精度和计算效率之间取得了卓越的平衡。在Llama-3.1-8B-Instruct的基础上进一步优化，提升了推理能力，支持 128K tokens 的上下文长度。
