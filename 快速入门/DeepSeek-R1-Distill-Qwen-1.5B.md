...
DeepSeek-R1-Distill-Qwen-1.5B是DeepSeek AI从DeepSeek-R1模型中蒸馏出来的Qwen模型，比经过强化学习训练出来的小型稠密模型拥有更好的推理能力。参数量为15亿，专为移动端或嵌入式设备优化。

## 核心特点
### 极致轻量化
1.5B 模型可在低至 8GB 内存的设备上运行，支持离线部署（如通过 Ollama 框架）。
### 场景灵活性
